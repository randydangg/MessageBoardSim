...
//      System.out.println("Enter the IP address of a machine running the capitalize server:");
     ...
     //my idea; create an initial GUI asking for IP and Port to form a connection, and then a separate GUI 
     //for user inputs. That way, if the port# and IP addresses don't match, connection will fail 
	}
}
